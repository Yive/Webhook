...
public class PaymentRefundedHandler implements Handler {
    ...
    public void handle(@NotNull Context ctx) throws Exception {
        ...
        Embed embed = DiscordUtils.createEmbed("Payment Refunded", payment, subject, revenue);

        embed.setColor(Math.round(Math.max(0, revenue) * 100.0) / 100.0 > 0 ? DiscordUtils.convertColour(255, 255, 255) : DiscordUtils.convertColour(128, 128, 128));
